          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link href="/reseller" className="text-gray-300 hover:text-[#FF6B35] transition-colors text-sm">
                {language === 'es' ? 'Revendedor' : 'Reseller'}
              </Link>
            </div>
          </div>
        </div>
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
              {posts.map((post, index) => (
                ...
                >
                  <Card 
                    className="glass border-[#2A2A2A] overflow-hidden h-full flex flex-col card-hover cursor-pointer"
        ...
        {selectedPost && (
          ...
          >
            <motion.div
              ...
              className="glass border border-[#2A2A2A] rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden"
              onClick={e => e.stopPropagation()}
            >
              {/* Modal Header */}
              <div className="sticky top-0 glass border-b border-[#2A2A2A] p-4 flex items-center justify-between z-10">
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => setSelectedPost(null)}
